...
Carsten: I just wanted to point out that we shouldn't adopt requirements on Chairs to completely give up any, any privacy here and the need to disclose something should be limited to the cases where we actually need it, and then it should be limited to the chair recusing without necessarily explaining why the chair is recusing themselves.
...
Dirk: There were comments that some of the wording sounds a bit vague, but I'm not sure it will make a difference. For example, resiliency is a bit unclear what it has to do with sustainability.
